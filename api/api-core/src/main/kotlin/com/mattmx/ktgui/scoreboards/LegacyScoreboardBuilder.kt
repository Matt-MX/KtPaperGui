...
open class LegacyScoreboardBuilder(
     ...
     */
    infix fun title(title: String): LegacyScoreboardBuilder {
        this.title = title
     ...
     */
    fun clear(): LegacyScoreboardBuilder {
     ...
     */
    fun set(index: Int, line: String): LegacyScoreboardBuilder {
    ...
    fun setRGB(index: Int, line: String): LegacyScoreboardBuilder {
        if (index >= MAX_LINES) throw IndexOutOfBoundsException("Index too high. Maximum index is 15 (0-15).")
        if (index >= scoreboardLines.size) {
            repeat(index - scoreboardLines.size + 1) {
                whitespace()
     ...
     */
    fun remove(index: Int): LegacyScoreboardBuilder {
        scoreboard.resetScores(scoreboardLines[index])
        return this
    }
     ...
     */
    fun add(line: String): LegacyScoreboardBuilder {
     ...
     */
    fun whitespace(): LegacyScoreboardBuilder {
        add(" ")
        return this
    }
